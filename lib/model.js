...
AbstractClass._forDB = function (data) {
    ...
    Object.keys(data).forEach(function (propName) {
        ...
        /*
            This is the reason jugglingdb sucks monkey balls
            ==================================================
            Fix creation of double arrays
            E.g.: input is [{}, {}] juggling creates [ [ {}, {} ] ]
            Edge case: This breaks with an array of arrays
        */
        if (data[propName] instanceof Array) {
            if(data[propName].length === 1 && data[propName][0] instanceof Array) {
                val = data[propName][0];
            } else {
                val = data[propName];
            }
